    ...
    public class PagamentosController : Controller
    {
            ...
            string status, string paymentStatusDetail, decimal valor, string tipoPagamento)
        {
            ...
            Pagamento pagamento = new Pagamento
            {
                ...
                Cupom = extRef.CodigoCupom
            };

            _context.Pagamentos.Add(pagamento);

            Cupom cupom = _context.Cupons.Where(c => c.Codigo == extRef.CodigoCupom).SingleOrDefault();
        ...
        // Teste no IIS LOCAL (Não funciona no IIS Express): http://Cyrex20.ddns.net:85/upfirst/en/pagamentos/MercadoPagoWebHook
