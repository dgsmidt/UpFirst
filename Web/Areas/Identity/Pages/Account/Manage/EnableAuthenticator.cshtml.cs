...
namespace WebCore.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!is2faTokenValid)
            {
                var invCode = _loc.GetLocalizedString(culture, "Verification code is invalid.");
            ...
            StatusMessage = _loc.GetLocalizedString(culture, "Your authenticator app has been verified.");
